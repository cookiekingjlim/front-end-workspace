...
function btn3() {
    ...
    console.log(div);
    console.log(div[0]);    // 첫 번째 것만 접근하겠다.
}
...
function btn6() {
    ...
    div = document.querySelector(".testClass"); /* querySelector는 무조건 맨 첫 번째에 해당하는 것만 가져옴*/
    console.log(div);
